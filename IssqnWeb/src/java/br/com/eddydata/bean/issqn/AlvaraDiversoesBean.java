...
import br.com.eddydata.servico.issqn.IssqnAlvaraDiversoesServico;
...
@Named
@ViewScoped
public class AlvaraDiversoesBean implements Serializable {

    private static final long serialVersionUID = 1L;

    @EJB
    private IssqnAlvaraDiversoesServico alvaraServico;
    @EJB
    ...
    private IssqnAlvaraDiversoesPublicas selectedRegistro;
    private List<IssqnAlvaraDiversoesPublicas> listRegistro;
    ...
    public void filtrar() {
        if (textoFiltro != null && !"".equals(textoFiltro)) {
            try {
                listRegistro = alvaraServico.obterAlvarasDiversoes(textoFiltro, 100);
            } catch (Exception ex) {
    ...
    public void adicionar() {
        selectedRegistro = new IssqnAlvaraDiversoesPublicas();
    }

    public void alterar(IssqnAlvaraDiversoesPublicas registroSelecionado) {
    ...
    private boolean salvarRegistro() {
        ...
        try {
            selectedRegistro = alvaraServico.salvarAlvaraDiversoes(selectedRegistro);
    ...
    public void imprimirAlvara() {
        ...
        try {
            alvaraServico.imprimirAlvaraDiversao(selectedRegistro.getId(), global.getUsuarioLogado().getOrgao().getIdOrgao());
        } catch (Exception ex) {
    ...
    public void remover() {
        try {
            alvaraServico.removerAlvaraDiversoes(selectedRegistro.getId());
        } catch (Exception ex) {
    ...
    public void carregarListagem() {
        try {
            listRegistro = alvaraServico.obterAlvarasDiversoes("", 100);
        } catch (Exception ex) {
    ...
    //------------ getters e setters ---------------//
    public IssqnAlvaraDiversoesPublicas getSelectedRegistro() {
        return selectedRegistro;
    }

    public void setSelectedRegistro(IssqnAlvaraDiversoesPublicas selectedRegistro) {
        this.selectedRegistro = selectedRegistro;
    }

    public List<IssqnAlvaraDiversoesPublicas> getListRegistro() {
        return listRegistro;
    }

    public void setListRegistro(List<IssqnAlvaraDiversoesPublicas> listRegistro) {
