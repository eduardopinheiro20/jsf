...
@Named
@ViewScoped
public class TermoFiscalizacaoBean implements Serializable {
    ...
    private IssqnTermoFiscalizacao selectedRegistro;
    private List<IssqnTermoFiscalizacao> listRegistro;
    ...
    public void adicionar() {
        selectedRegistro = new IssqnTermoFiscalizacao();
    }

    public void alterar(IssqnTermoFiscalizacao registroSelecionado) {
    ...
    public void imprimir() {
        ...
        try {
            servico.imprimirTermoFiscalizacao(selectedRegistro.getId(), global.getUsuarioLogado().getOrgao().getIdOrgao());
        } catch (Exception ex) {
    ...
    public void selecionarIssqn() {
        ...
        if (p != null) {
            selectedRegistro.setEstabelecimento(p.getNome());
    ...
    //------------ getters e setters ---------------//
    public IssqnTermoFiscalizacao getSelectedRegistro() {
        return selectedRegistro;
    }

    public void setSelectedRegistro(IssqnTermoFiscalizacao selectedRegistro) {
        this.selectedRegistro = selectedRegistro;
    }

    public List<IssqnTermoFiscalizacao> getListRegistro() {
        return listRegistro;
    }

    public void setListRegistro(List<IssqnTermoFiscalizacao> listRegistro) {
