...
import br.com.eddydata.servico.issqn.TermoApreensaoServico;
...
@Named
@ViewScoped
public class TermoApreensaoBean implements Serializable {

    private static final long serialVersionUID = 1L;

    @EJB
    private TermoApreensaoServico servico;
    @EJB
    ...
    private IssqnTermoApreensao selectedRegistro;
    private List<IssqnTermoApreensao> listRegistro;
    ...
    public void adicionar() {
        selectedRegistro = new IssqnTermoApreensao();
    }

    public void alterar(IssqnTermoApreensao registroSelecionado) {
    ...
    public void imprimir() {
        ...
        try {
            servico.imprimirTermoApreensao(selectedRegistro.getId(), global.getUsuarioLogado().getOrgao().getIdOrgao());
        } catch (Exception ex) {
    ...
    public void selecionarIssqn() {
        ...
        if (p != null) {
            ...
            selectedRegistro.setDataEmissao(p.getDtAbertura());
    ...
    //------------ getters e setters ---------------//
    public IssqnTermoApreensao getSelectedRegistro() {
        return selectedRegistro;
    }

    public void setSelectedRegistro(IssqnTermoApreensao selectedRegistro) {
        this.selectedRegistro = selectedRegistro;
    }

    public List<IssqnTermoApreensao> getListRegistro() {
        return listRegistro;
    }

    public void setListRegistro(List<IssqnTermoApreensao> listRegistro) {
