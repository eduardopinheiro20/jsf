...
import br.com.eddydata.repositorio.issqn.TermoApreensaoRepositorio;
...
public class TermoApreensaoServico extends Servico {
    ...
    private TermoApreensaoRepositorio repositorio;

    @PostConstruct
    @PostActivate
    private void aposConstruir() {
        repositorio = new TermoApreensaoRepositorio(em);
    }
     ...
     * @throws Exception
     */
    public IssqnTermoApreensao salvar(IssqnTermoApreensao ad) throws BusinessViolation, Exception {
        try {
    ...
    public void remover(int id) throws BusinessViolation, Exception {
        IssqnTermoApreensao t = repositorio.obterPorId(id);
        if (t == null) {
     ...
     * @throws Exception
     */
    public IssqnTermoApreensao obterPorId(int id) throws BusinessViolation, Exception {
        IssqnTermoApreensao t;
     ...
     * @throws Exception
     */
    public List<IssqnTermoApreensao> listar(String filtro, Integer limite) throws Exception {
     ...
     * @throws Exception
     */
    public void imprimirTermoApreensao(Integer alvaraId, String orgaoId) throws Exception {
        if (alvaraId == null) {
        ...
        repositorio.imprimirTermoApreensao(alvaraId, orgaoId);
    }
    ...
    public void imprimirTermoApreensao(Date dtInicial,Date dtFinal,String orgaoId) throws Exception {        
        ...
        repositorio.imprimirTermoApreensao(dtInicial, dtFinal, orgaoId);
    }
