...
import br.com.eddydata.servico.issqn.IssqnAutoInfracaoServico;
...
public class AutoInfracaoBean implements Serializable {
    ...
    @EJB
    private IssqnAutoInfracaoServico servico;
    @EJB
    ...
    private IssqnAutoInfracao selectedRegistro;
    private List<IssqnAutoInfracao> listRegistro;
    ...
    public void filtrar() {
        if (textoFiltro != null && !"".equals(textoFiltro)) {
            try {
                listRegistro = servico.obterAutoInfracoes(textoFiltro, 100);
            } catch (Exception ex) {
    ...
    public void adicionar() {
        selectedRegistro = new IssqnAutoInfracao();
    }

    public void alterar(IssqnAutoInfracao registroSelecionado) {
    ...
    private boolean salvarRegistro() {
        ...
        try {
            selectedRegistro = servico.salvarAutoInfracao(selectedRegistro);
    ...
    public void imprimirAlvara() {
        ...
        try {
            servico.imprimirAutoInfracao(selectedRegistro.getId(), global.getUsuarioLogado().getOrgao().getIdOrgao());
        } catch (Exception ex) {
    ...
    public void remover() {
        try {
            servico.removerAutoInfracao(selectedRegistro.getId());
        } catch (Exception ex) {
    ...
    public void carregarListagem() {
        try {
            listRegistro = servico.obterAutoInfracoes("", 100);
        } catch (Exception ex) {
    ...
    //------------ getters e setters ---------------//
    public IssqnAutoInfracao getSelectedRegistro() {
        return selectedRegistro;
    }

    public void setSelectedRegistro(IssqnAutoInfracao selectedRegistro) {
        this.selectedRegistro = selectedRegistro;
    }

    public List<IssqnAutoInfracao> getListRegistro() {
        return listRegistro;
    }

    public void setListRegistro(List<IssqnAutoInfracao> listRegistro) {
