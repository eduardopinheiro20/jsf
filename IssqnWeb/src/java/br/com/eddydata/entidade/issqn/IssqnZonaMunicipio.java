 ...
 */
@Entity
@Table(name = "issqn_zona_municipio")
public class IssqnZonaMunicipio implements Serializable {

    private static final long serialVersionUID = 1L;

    public IssqnZonaMunicipio() {
        this.ativo = true;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final IssqnZonaMunicipio other = (IssqnZonaMunicipio) obj;
